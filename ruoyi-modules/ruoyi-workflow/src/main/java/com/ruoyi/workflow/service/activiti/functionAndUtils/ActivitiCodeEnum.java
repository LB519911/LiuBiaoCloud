...
public enum ActivitiCodeEnum implements ActivitiBaseEnum {
    // 通用部分:0-10
    SUCCESS(0, "成功"),
    ERROR(1, "失败"),
     ...
     */
    ActivitiCodeEnum(int code, String description) {
        this.code = code;
    ...
    public static String getMsgByCodeInt(int codeInt) {
        for (ActivitiCodeEnum e : ActivitiCodeEnum.values()) {
    ...
    private static final Map<Integer, ActivitiCodeEnum> CODE_ENUM_MAP = new HashMap<>();

    static {
        for (ActivitiCodeEnum a : ActivitiCodeEnum.values()) {
     ...
     * @return CodeEnum
     */
    public static ActivitiCodeEnum getEnumByCode(Integer code) {
