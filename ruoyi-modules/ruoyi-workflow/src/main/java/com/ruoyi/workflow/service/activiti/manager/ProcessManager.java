...
import com.ruoyi.workflow.service.activiti.functionAndUtils.ActivitiBusinessException;
import com.ruoyi.workflow.service.activiti.functionAndUtils.ActivitiCodeEnum;
import com.ruoyi.workflow.service.activiti.functionAndUtils.ActivitiVerificationUtils;
import com.ruoyi.workflow.service.activiti.functionAndUtils.ProcessDefinitionVO;
...
public class ProcessManager {
    ...
    public void suspendProcessDefinitionByName(String processDefinitionName) {
        ProcessDefinition processDefinition = ActivitiVerificationUtils.checkProcessDefinitionByName(processDefinitionName);
    ...
    public Boolean getProcessDefinitionStatusByName(String processDefinitionName) {
        // 先检查是否存在，不需要获取返回值
        ActivitiVerificationUtils.checkProcessDefinitionByName(processDefinitionName);
    ...
    public ProcessDefinitionVO getProcessDefinitionByName(String processDefinitionName) {
        return toProcessDefinitionDTO(ActivitiVerificationUtils.checkProcessDefinitionByName(processDefinitionName));
    }
    ...
    public ProcessDefinitionVO deployProcessDefinition(String processDefinitionName, String bpmnPath) {
        ...
        try {
            ...
            throw new ActivitiBusinessException(ActivitiCodeEnum.DEPLOY_PROCESS_ERROR, e.getMessage());
        }
    }
